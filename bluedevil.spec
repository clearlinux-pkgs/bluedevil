...
Source0  : https://download.kde.org/stable/plasma/6.1.0/bluedevil-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/bluedevil-6.1.0.tar.xz.sig
...
%setup -q -n bluedevil-6.1.0
cd %{_builddir}/bluedevil-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718894168
mkdir -p clr-build
pushd clr-build
