...
Version  : 5.27.10
Release  : 91
URL      : https://download.kde.org/stable/plasma/5.27.10/bluedevil-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/bluedevil-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/bluedevil-5.27.10.tar.xz.sig
...
%prep
%setup -q -n bluedevil-5.27.10
cd %{_builddir}/bluedevil-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701919528
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt5/plugins/kf5/kded/bluedevil.so
/V3/usr/lib64/qt5/plugins/kf5/kio/kio_bluetooth.so
/V3/usr/lib64/qt5/plugins/kf5/kio/kio_obexftp.so
/V3/usr/lib64/qt5/plugins/plasma/kcms/systemsettings/kcm_bluetooth.so
/V3/usr/lib64/qt5/qml/org/kde/plasma/private/bluetooth/libbluetoothplugin.so
