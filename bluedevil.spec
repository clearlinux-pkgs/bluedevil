...
export LANG=C
export SOURCE_DATE_EPOCH=1539108219
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.LIB %{buildroot}/usr/share/doc/bluedevil/COPYING.LIB
pushd clr-build
%make_install
popd
%find_lang bluedevil
...
/usr/share/doc/bluedevil/COPYING
/usr/share/doc/bluedevil/COPYING.LIB
