...
Source0  : https://download.kde.org/stable/plasma/6.0.4/bluedevil-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/bluedevil-6.0.4.tar.xz.sig
...
%setup -q -n bluedevil-6.0.4
cd %{_builddir}/bluedevil-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713317877
mkdir -p clr-build
pushd clr-build
