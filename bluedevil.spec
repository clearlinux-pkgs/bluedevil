...
Version  : 5.27.3
Release  : 83
URL      : https://download.kde.org/stable/plasma/5.27.3/bluedevil-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/bluedevil-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/bluedevil-5.27.3.tar.xz.sig
...
%prep
%setup -q -n bluedevil-5.27.3
cd %{_builddir}/bluedevil-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679508549
mkdir -p clr-build
pushd clr-build
