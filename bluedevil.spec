...
Version  : 6.0.5.1
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.0.5/bluedevil-6.0.5.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/bluedevil-6.0.5.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/bluedevil-6.0.5.1.tar.xz.sig
...
%setup -q -n bluedevil-6.0.5.1
cd %{_builddir}/bluedevil-6.0.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716478246
mkdir -p clr-build
pushd clr-build
